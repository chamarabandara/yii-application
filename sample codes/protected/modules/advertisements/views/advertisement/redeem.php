                                                    ...
                                                    <tbody>                               
                                                                ...
                                                                <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                                                    <tr><td>
                                                                            <table>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="bold-text" align="left"><?php
                                                                                        if ($advertisement->in_airport)
                                                                                            echo 'Councourse ' . $advertisement->concourse;
                                                                                        else
                                                                                ...
                                                                                <tr>
                                                                                    <td class="bold-text break-word"  align="left" style="width: 320px;"><div style="word-break:break-all;"><?php echo $advertisement->url ?></div></td>
                                                                                </tr>
                                                                                <tr>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <table>
                                                                    <tr>
                                                                        <td><?php echo CHtml::image(empty($advertisement->qr_code_image_name) ? Yii::app()->params['hostname'] . $advertisement->image_url : Yii::app()->params['hostname'] . $advertisement->qr_code_image_name, '', array('width' => '136px')); ?></td>
                                                                        <td valign="top">
                                                                            <table>
                                                                                <tr>
                                                                    ...
                                                                    <tr> 
                                                                        <td align="middle" width="136px"><?php echo $advertisement->qr_code ?></td>
                                                                        <td></td>
                                                                    </tr>
                                                                </table>                                   
                                                            </td>                          
                                                        ...
                                                        <tr>
                                                            <td align="center" class="title"><?php
                                                                if (strlen($advertisement->terms) > 30) {
                                                                    echo substr($advertisement->terms, 0, 27) . '...';
                                                                }
                                                                else
                                                                    echo $advertisement->terms;
                                                                ?></td>
                                                        </tr>
                                                        <tr>
                                                            <td align="center" class="green-text bold-text"><br />Use this coupon until it expires!</td>
                                                        </tr>
                                                    </tbody>
                                                </table></div>
                                        </div>
